        ...
        >
          <CardContent className="p-0 space-y-0">
            <div className="grid grid-cols-2 gap-0">
              <div className="aspect-square bg-black/5 flex items-center justify-center border-r border-b border-black/10 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-black/5 to-transparent" />
                <p className="text-sm text-black/40 font-medium relative z-10">לפני</p>
              </div>
              <div className="aspect-square bg-gold-400/5 flex items-center justify-center border-b border-black/10 relative overflow-hidden">
