            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <div className="text-xl text-white/80 leading-relaxed space-y-6">
                  ...
                  <p>
                    אחרי למעלה מ-8 שנות ניסיון בתחום, פתחתי ב-קריית ים קליניקה חדשה ואינטימית - עם מכשור חדיש ומתקדם, סביבה נקייה ונעימה, ומקום שבו נשים מרגישות נינוחות, בטוחות, ומקבלות טיפול שבאמת משנה את העור.
                  </p>
                  <p>
                    לא מרפאה גדולה ולא "סלון יופי", אלא מרחב חדש של אמון, מקצועיות והקשבה אמיתית.
                  </p>
                </div>
              </div>
